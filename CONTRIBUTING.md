...
Send an email to **patches@nvidia-open-letter.netplayz.dev** with your details.
...
1. Your email arrives at `patches@nvidia-open-letter.netplayz.dev`
...
3. In Cloudflare Dashboard > Email Routing:
   - Add address: `patches@nvidia-open-letter.netplayz.dev`
